...
<script src="https://kit.fontawesome.com/7a2820e1a2.js"
	...
	<div class="bg-imag">
		<div class="jb-box">
			<video muted autoplay loop>
				<source src="/resources/index_images/indexVideo.mp4"video/mp4">
			</video>
		</div>
		<div class="bg-text">
			<div
				style="background-color: rgba(255, 248, 248, 0.00); border-radius: 6%;">
				...
				<div class="" style="padding: 10px 10px;">
					<div class="mb-2">
						<span><img
							src="/resources/index_images/kakao_login_medium_narrow.png"
							alt="" width="40%"></span> <span><img
							src="/resources/index_images/kakao_login_medium_narrow.png"
							alt="" width="40%"></span>
					</div>
					<div class="">
						<span><img
							src="/resources/index_images/네이버 아이디로 로그인_완성형_Green.PNG" alt=""
		...
		<div class="modal-dialog  modal-lg modal-dialog-centered"
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="margin: 0 45px;">
					<form action="">
						<div class="form-group text-left">
							<label for="signin-id" style="font-size: 20px;">아이디</label> <input
								type="text" class="form-control" id="signup-id">
						</div>
						<div class="form-group text-left">
						...
						<div class="form-group text-left">
							<label for="signin-id" style="font-size: 20px;">전화번호</label> <input
								type="text" class="form-control" id="signup-tel">
						</div>
						<div class="form-group text-left">
							<label for="signin-id" style="font-size: 20px;">이름</label> <input
						...
						<div class="form-group text-left">
							<label for="signin-id" style="font-size: 20px;">생년월일</label> <input
								type="text" class="form-control" id="signup-birth">
						</div>
						<div class="form-group text-left">
							<label for="signin-id" style="font-size: 20px;">이메일</label> <input
								type="text" class="form-control" id="signup-email">
						</div>
					</form>
				</div>
	...
	<div class="modal" id="select-category-modal">
		<div class="modal-dialog modal-lg modal-dialog-centered"
			...
			<div class=" modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body" style="margin: 5px 31px;"
					id="select-category-image">
					<form action="">
						<label> <input type="radio" name="test" value="small">
							<div class="card mycard">
								<img class="card-img-top myimg"
									src="/resources/index_images/반려동물.png" alt="Card image">
							...
							<div class="card mycard">
								<img class="card-img-top myimg"
									src="/resources/index_images/게임.jpg" alt="Card image">
								<div class="card-img-overlay">
							...
							<div class="card mycard">
								<img class="card-img-top myimg"
									src="/resources/index_images/사교인맥.png" alt="Card image">
								<div class="card-img-overlay">
							...
							<div class="card mycard">
								<img class="card-img-top myimg"
									src="/resources/index_images/스포츠.png" alt="Card image">
								<div class="card-img-overlay">
							...
							<div class="card mycard">
								<img class="card-img-top myimg"
									src="/resources/index_images/문화공연.jpg" alt="Card image">
								<div class="card-img-overlay">
							...
							<div class="card mycard" style="opacity: 0.5;">
								<img class="card-img-top myimg"
									src="/resources/index_images/음악.png" alt="Card image">
								<div class="card-img-overlay">
